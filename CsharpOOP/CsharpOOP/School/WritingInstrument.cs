...
namespace CsharpOOP.School
{
    abstract public class WritingInstrument
    {
        ...
        /*
            ...
            Create a Pencil class that has a similar behaviour to Pen, 
        except uses a GraphiteRemaining property rather than ink level.
        ...
        // An abstract method / prop MUST be overwritten by all derived classes.
        ...
        abstract public void Write(int characterCount);
